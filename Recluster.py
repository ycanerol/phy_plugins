...
class Recluster(IPlugin):
    def attach_to_controller(self, controller):
        ...
        def on_gui_ready(sender, gui):
            ...
            @controller.supervisor.actions.add(shortcut='ctrl+alt+q', prompt=True,
            ...
            @controller.supervisor.actions.add(shortcut='ctrl+alt+a', prompt=True,
                                               prompt_default=lambda: 2,
                                               submenu='Clustering')
            ...
            @controller.supervisor.actions.add(shortcut='ctrl+alt+x', prompt=True,
